...
/**
 * RGB摄像头动作活体检测+1:N 人脸搜索识别。only Test
 *
 * 摄像头管理源码开放在 {@link FaceCameraXFragment}
 * @author FaceAISDK.Service@gmail.com
 */
@Deprecated
public class FaceSearch_MotionLiveness_Activity extends AbsBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //可以使用开放的摄像头管理源码MyCameraFragment，自行管理摄像头
...
//                    setMainTips(R.string.no_face_or_repeat_switch_screen);
    ...
    private void initFaceSearchParam() {
        ...
        SearchProcessBuilder faceProcessBuilder = new SearchProcessBuilder.Builder(this)
                ...
                .setThreshold(0.85f) //阈值范围限[0.8 , 0.9] 搜索识别可信度，阈值高摄像头成像品质宽动态值以及人脸底片质量也要高
